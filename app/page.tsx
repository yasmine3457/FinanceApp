...
import { ArrowRight, BookOpen, BarChart3, FileText, Shield, Lightbulb } from "lucide-react"
      ...
      <header className="border-b bg-white">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/about" className="text-sm font-medium text-emerald-900 hover:text-emerald-700">
              About
            </Link>
          </nav>
          <Link href="/register">
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-5xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
             <a href="try-platforme">
  <Button className="bg-emerald-600 hover:bg-emerald-700 text-lg py-6 px-8">
    Try the Platform
  </Button>
</a>

              <Button variant="outline" className="text-lg py-6 px-8 border-emerald-600 text-emerald-700">
                Learn More
              </Button>
            </div>
          </div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="border-emerald-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardFooter>
                  <Link href="/standards-identification">
                    <Button variant="ghost" className="text-emerald-600 hover:text-emerald-700 p-0 flex items-center">
              ...
              <Card className="border-emerald-100 shadow-sm hover:shadow-md transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle className="text-emerald-800">Standards Enhancement</CardTitle>
                  <CardDescription>Multi-agent AI system to review and enhance AAOIFI standards</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
                    Our AI agents collaborate to review, suggest improvements, and validate updates to AAOIFI standards.
                  </p>
                </CardContent>
                <CardFooter>
                  <Link href="/standards-enhancement">
                    <Button variant="ghost" className="text-emerald-600 hover:text-emerald-700 p-0 flex items-center">
                      Enhance Standards <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
                  </Link>
                </CardFooter>
              </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/enhancement" className="text-emerald-100 hover:text-white">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/documentation" className="text-emerald-100 hover:text-white">
                    Documentation
                  </Link>
                </li>
                <li>
                  <Link href="/api" className="text-emerald-100 hover:text-white">
                    API
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/faq" className="text-emerald-100 hover:text-white">
                    FAQ
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/support" className="text-emerald-100 hover:text-white">
                    Support
                  </Link>
                </li>
                <li>
                  <Link href="/partners" className="text-emerald-100 hover:text-white">
                    Partners
                  </Link>
                </li>
              </ul>
